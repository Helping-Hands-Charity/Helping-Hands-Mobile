...
class AllDonors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List myData = [
      "Child care fund",
      "Donated for children from low income families"
    ];
          ...
          Container(
            ...
            child: InkWell(
              ...
              child: Icon(Icons.arrow_back,
                  color: Color.fromARGB(137, 219, 217, 217)),
            ),
            ...
            decoration: BoxDecoration(
              ...
              fit: BoxFit.cover,
              image: AssetImage("img/allDonor.jpg"),
            )),
          ),
          Container(
